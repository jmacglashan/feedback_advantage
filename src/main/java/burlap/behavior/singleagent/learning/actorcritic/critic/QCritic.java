 ...
 */
public class QCritic implements Critic {
    ...
    public QCritic(EnumerablePolicy actor, SADomain domain, HashableStateFactory hashingFactory, double gamma, double viDelta, int maxIterations) {
        this.actor = actor;
        this.domain = domain;
